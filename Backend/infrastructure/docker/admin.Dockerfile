# Produktions-Image des Next.js-Admin-Dashboards. Build-Kontext: Backend/.
...
# Vollständiger Workspace-Kontext, damit `next start` die @yunity/*-Pakete auflöst.
...
CMD ["npm", "run", "start", "-w", "@yunity/admin"]
